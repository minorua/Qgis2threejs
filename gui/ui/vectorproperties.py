...
class Ui_VectorPropertiesWidget(object):
    def setupUi(self, VectorPropertiesWidget):
        ...
        self.groupBox_Geometry = QtWidgets.QGroupBox(parent=self.scrollAreaWidgetContents)
        ...
        self.label_ObjectType = QtWidgets.QLabel(parent=self.groupBox_Geometry)
        ...
        self.comboBox_ObjectType = QtWidgets.QComboBox(parent=self.groupBox_Geometry)
        ...
        self.comboEdit_FilePath = PropertyWidget(parent=self.groupBox_Geometry)
        ...
        self.verticalLayout_10.addWidget(self.groupBox_Geometry)
