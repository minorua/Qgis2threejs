...
class Ui_Q3DWindow(object):
    def setupUi(self, Q3DWindow):
        ...
        self.menuControls = QtWidgets.QMenu(parent=self.menuView)
        ...
        self.actionGraphicsInfo = QtGui.QAction(parent=Q3DWindow)
        self.actionGraphicsInfo.setObjectName("actionGraphicsInfo")
        self.actionSaveAsJSON = QtGui.QAction(parent=Q3DWindow)
        self.actionSaveAsJSON.setObjectName("actionSaveAsJSON")
        self.actionOrbitControls = QtGui.QAction(parent=Q3DWindow)
        self.actionOrbitControls.setCheckable(True)
        self.actionOrbitControls.setChecked(True)
        self.actionOrbitControls.setObjectName("actionOrbitControls")
        self.actionMapControls = QtGui.QAction(parent=Q3DWindow)
        self.actionMapControls.setCheckable(True)
        self.actionMapControls.setObjectName("actionMapControls")
        self.actionEnvironmentControls = QtGui.QAction(parent=Q3DWindow)
        self.actionEnvironmentControls.setCheckable(True)
        self.actionEnvironmentControls.setObjectName("actionEnvironmentControls")
        ...
        self.menuSaveAs.addAction(self.actionSaveAsJSON)
        ...
        self.menuHelp.addSeparator()
        self.menuHelp.addAction(self.actionGraphicsInfo)
        ...
        self.menuControls.addAction(self.actionOrbitControls)
        self.menuControls.addAction(self.actionMapControls)
        self.menuControls.addAction(self.actionEnvironmentControls)
    ...
    def retranslateUi(self, Q3DWindow):
        ...
        self.actionGraphicsInfo.setText(_translate("Q3DWindow", "Graphics Info"))
        self.actionSaveAsJSON.setText(_translate("Q3DWindow", "three.js JSON (.json)..."))
        self.actionOrbitControls.setText(_translate("Q3DWindow", "OrbitControls"))
        self.actionMapControls.setText(_translate("Q3DWindow", "MapControls"))
        self.actionEnvironmentControls.setText(_translate("Q3DWindow", "EnvironmentControls"))
