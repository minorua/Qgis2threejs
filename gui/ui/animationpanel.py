...
class Ui_AnimationPanel(object):
    def setupUi(self, AnimationPanel):
        ...
        self.toolButtonRemove = QtWidgets.QToolButton(parent=AnimationPanel)
        self.toolButtonRemove.setObjectName("toolButtonRemove")
        self.gridLayout_2.addWidget(self.toolButtonRemove, 0, 2, 1, 1)
        self.toolButtonPlay = QtWidgets.QToolButton(parent=AnimationPanel)
        ...
        self.toolButtonAdd = QtWidgets.QToolButton(parent=AnimationPanel)
        ...
        self.toolButtonEdit = QtWidgets.QToolButton(parent=AnimationPanel)
        self.toolButtonEdit.setObjectName("toolButtonEdit")
        self.gridLayout_2.addWidget(self.toolButtonEdit, 0, 1, 1, 1)
        self.checkBoxLoop = QtWidgets.QCheckBox(parent=AnimationPanel)
