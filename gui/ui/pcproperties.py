...
class Ui_PCPropertiesWidget(object):
    def setupUi(self, PCPropertiesWidget):
        ...
        PCPropertiesWidget.resize(382, 491)
        self.verticalLayout = QtWidgets.QVBoxLayout(PCPropertiesWidget)
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.scrollArea = QtWidgets.QScrollArea(parent=PCPropertiesWidget)
        self.scrollArea.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.scrollArea.setWidgetResizable(True)
        self.scrollArea.setObjectName("scrollArea")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 382, 491))
