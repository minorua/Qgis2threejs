...
class Ui_DEMPropertiesWidget(object):
    def setupUi(self, DEMPropertiesWidget):
        ...
        DEMPropertiesWidget.resize(382, 489)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 352, 483))
        ...
        self.labelAltitude = QtWidgets.QLabel(parent=self.scrollAreaWidgetContents)
        ...
        self.lineEdit_Altitude = QtWidgets.QLineEdit(parent=self.scrollAreaWidgetContents)
        ...
        self.verticalLayout_3.addLayout(self.formLayout_Altitude)
        self.groupBoxResampMethod = QtWidgets.QGroupBox(parent=self.scrollAreaWidgetContents)
        ...
        self.spinBox_TileSideSegments = QtWidgets.QSpinBox(parent=self.groupBoxResampMethod)
        ...
        self.formLayoutOriginalValues.setWidget(1, QtWidgets.QFormLayout.ItemRole.SpanningRole, self.labelOriginalValues)
        self.verticalLayout_5.addLayout(self.formLayoutOriginalValues)
        self.verticalLayout_3.addWidget(self.groupBoxResampMethod)
        self.groupBoxClip = QtWidgets.QGroupBox(parent=self.scrollAreaWidgetContents)
        ...
        self.verticalLayout_3.addWidget(self.groupBoxClip)
        self.groupBoxTiles = QtWidgets.QGroupBox(parent=self.scrollAreaWidgetContents)
        ...
        self.verticalLayout_3.addWidget(self.groupBoxTiles)
        ...
        self.scrollArea_2 = QtWidgets.QScrollArea(parent=self.tabMaterials)
        self.scrollArea_2.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.scrollArea_2.setWidgetResizable(True)
        self.scrollArea_2.setObjectName("scrollArea_2")
        self.scrollAreaWidgetContents_2 = QtWidgets.QWidget()
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 352, 483))
        ...
        self.toolButton_RemoveMtl = QtWidgets.QToolButton(parent=self.scrollAreaWidgetContents_2)
        ...
        self.toolButton_AddMtl = QtWidgets.QToolButton(parent=self.scrollAreaWidgetContents_2)
        ...
        self.verticalLayout_6.addLayout(self.gridLayout_MtlBtns)
        self.listWidget_Materials = QtWidgets.QListWidget(parent=self.scrollAreaWidgetContents_2)
        self.listWidget_Materials.setObjectName("listWidget_Materials")
        self.verticalLayout_6.addWidget(self.listWidget_Materials)
        self.gridLayout_Mtl = QtWidgets.QGridLayout()
        self.gridLayout_Mtl.setObjectName("gridLayout_Mtl")
        self.horizontalSlider_Opacity = QtWidgets.QSlider(parent=self.scrollAreaWidgetContents_2)
        ...
        self.checkBox_TransparentBackground = QtWidgets.QCheckBox(parent=self.scrollAreaWidgetContents_2)
        ...
        self.spinBox_Opacity = QtWidgets.QSpinBox(parent=self.scrollAreaWidgetContents_2)
        ...
        self.label_TextureSize = QtWidgets.QLabel(parent=self.scrollAreaWidgetContents_2)
        ...
        self.lineEdit_ImageFile = QtWidgets.QLineEdit(parent=self.scrollAreaWidgetContents_2)
        self.lineEdit_ImageFile.setObjectName("lineEdit_ImageFile")
        self.gridLayout_Mtl.addWidget(self.lineEdit_ImageFile, 4, 1, 1, 1)
        self.checkBox_Shading = QtWidgets.QCheckBox(parent=self.scrollAreaWidgetContents_2)
        ...
        self.label_LayerImage = QtWidgets.QLabel(parent=self.scrollAreaWidgetContents_2)
        ...
        self.colorButton_Color = QgsColorButton(parent=self.scrollAreaWidgetContents_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.toolButton_SelectLayer = QtWidgets.QToolButton(parent=self.scrollAreaWidgetContents_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.label_Format = QtWidgets.QLabel(parent=self.scrollAreaWidgetContents_2)
        self.label_Format.setObjectName("label_Format")
        self.gridLayout_Mtl.addWidget(self.label_Format, 3, 0, 1, 1)
        self.label_Layers = QtWidgets.QLabel(parent=self.scrollAreaWidgetContents_2)
        ...
        self.comboBox_TextureSize = QtWidgets.QComboBox(parent=self.scrollAreaWidgetContents_2)
        ...
        self.label_ImageFile = QtWidgets.QLabel(parent=self.scrollAreaWidgetContents_2)
        self.label_ImageFile.setObjectName("label_ImageFile")
        self.gridLayout_Mtl.addWidget(self.label_ImageFile, 4, 0, 1, 1)
        self.label_Color = QtWidgets.QLabel(parent=self.scrollAreaWidgetContents_2)
        self.label_Color.setObjectName("label_Color")
        self.gridLayout_Mtl.addWidget(self.label_Color, 5, 0, 1, 1)
        self.toolButton_ImageFile = QtWidgets.QToolButton(parent=self.scrollAreaWidgetContents_2)
        ...
        self.radioButton_WebP = QtWidgets.QRadioButton(parent=self.scrollAreaWidgetContents_2)
        self.radioButton_WebP.setChecked(True)
        self.radioButton_WebP.setObjectName("radioButton_WebP")
        self.gridLayout_2.addWidget(self.radioButton_WebP, 0, 0, 1, 1)
        self.radioButton_JPEG = QtWidgets.QRadioButton(parent=self.scrollAreaWidgetContents_2)
        self.radioButton_JPEG.setObjectName("radioButton_JPEG")
        self.gridLayout_2.addWidget(self.radioButton_JPEG, 0, 1, 1, 1)
        self.radioButton_PNG = QtWidgets.QRadioButton(parent=self.scrollAreaWidgetContents_2)
        self.radioButton_PNG.setObjectName("radioButton_PNG")
        self.gridLayout_2.addWidget(self.radioButton_PNG, 0, 2, 1, 1)
        self.gridLayout_Mtl.addLayout(self.gridLayout_2, 3, 1, 1, 2)
        self.checkBox_FlatShading = QtWidgets.QCheckBox(parent=self.scrollAreaWidgetContents_2)
        self.checkBox_FlatShading.setObjectName("checkBox_FlatShading")
        self.gridLayout_Mtl.addWidget(self.checkBox_FlatShading, 11, 0, 1, 3)
        self.verticalLayout_6.addLayout(self.gridLayout_Mtl)
        ...
        self.checkBox_Shading.toggled['bool'].connect(self.checkBox_FlatShading.setEnabled) # type: ignore
        ...
        DEMPropertiesWidget.setTabOrder(self.radioButton_OriginalValues, self.spinBox_TileSideSegments)
        DEMPropertiesWidget.setTabOrder(self.spinBox_TileSideSegments, self.radioButton_ClipBaseExtent)
        ...
        DEMPropertiesWidget.setTabOrder(self.comboBox_TextureSize, self.radioButton_WebP)
        DEMPropertiesWidget.setTabOrder(self.radioButton_WebP, self.radioButton_JPEG)
        DEMPropertiesWidget.setTabOrder(self.radioButton_JPEG, self.radioButton_PNG)
        DEMPropertiesWidget.setTabOrder(self.radioButton_PNG, self.lineEdit_ImageFile)
        ...
        DEMPropertiesWidget.setTabOrder(self.checkBox_Shading, self.checkBox_FlatShading)
        DEMPropertiesWidget.setTabOrder(self.checkBox_FlatShading, self.checkBox_Sides)
        ...
        DEMPropertiesWidget.setTabOrder(self.checkBox_Clickable, self.tabWidget)
        DEMPropertiesWidget.setTabOrder(self.tabWidget, self.scrollArea)
        DEMPropertiesWidget.setTabOrder(self.scrollArea, self.scrollArea_2)
    ...
    def retranslateUi(self, DEMPropertiesWidget):
        ...
        self.radioButton_WebP.setText(_translate("DEMPropertiesWidget", "WebP"))
        ...
        self.checkBox_FlatShading.setText(_translate("DEMPropertiesWidget", "Flat shading"))
