...
class Ui_DEMPropertiesWidget(object):
    def setupUi(self, DEMPropertiesWidget):
        ...
        self.label_Resampling = QtWidgets.QLabel(parent=self.groupBox_Geometry)
        ...
        self.horizontalSlider_DEMSize = QtWidgets.QSlider(parent=self.groupBox_Geometry)
        ...
        self.label_ResamplingLevel = QtWidgets.QLabel(parent=self.groupBox_Geometry)
        ...
        self.label_Altitude = QtWidgets.QLabel(parent=self.groupBox_Geometry)
        self.label_Altitude.setMinimumSize(QtCore.QSize(110, 0))
        self.label_Altitude.setObjectName("label_Altitude")
        self.formLayout_Altitude.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_Altitude)
        self.lineEdit_Altitude = QtWidgets.QLineEdit(parent=self.groupBox_Geometry)
        ...
        self.checkBox_Clip = QtWidgets.QCheckBox(parent=self.groupBox_Geometry)
        self.checkBox_Clip.setObjectName("checkBox_Clip")
        self.verticalLayout_Clip.addWidget(self.checkBox_Clip)
        self.comboBox_ClipLayer = QtWidgets.QComboBox(parent=self.groupBox_Geometry)
        ...
        self.toolButton_RemoveMtl = QtWidgets.QToolButton(parent=self.groupBox_Material)
        ...
        self.toolButton_AddMtl = QtWidgets.QToolButton(parent=self.groupBox_Material)
        ...
        self.listWidget_Materials = QtWidgets.QListWidget(parent=self.groupBox_Material)
        ...
        self.label_17 = QtWidgets.QLabel(parent=self.groupBox_Material)
        self.label_17.setObjectName("label_17")
        self.gridLayout_Mtl.addWidget(self.label_17, 8, 0, 1, 1)
        self.spinBox_Opacity = QtWidgets.QSpinBox(parent=self.groupBox_Material)
        ...
        self.toolButton_ImageFile = QtWidgets.QToolButton(parent=self.groupBox_Material)
        ...
        self.colorButton_Color = QgsColorButton(parent=self.groupBox_Material)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.toolButton_SelectLayer = QtWidgets.QToolButton(parent=self.groupBox_Material)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.label_LayerImage = QtWidgets.QLabel(parent=self.groupBox_Material)
        ...
        self.checkBox_Shading = QtWidgets.QCheckBox(parent=self.groupBox_Material)
        ...
        self.label_TextureSize = QtWidgets.QLabel(parent=self.groupBox_Material)
        ...
        self.label_Color = QtWidgets.QLabel(parent=self.groupBox_Material)
        self.label_Color.setObjectName("label_Color")
        self.gridLayout_Mtl.addWidget(self.label_Color, 5, 0, 1, 1)
        self.label_Layers = QtWidgets.QLabel(parent=self.groupBox_Material)
        self.label_Layers.setObjectName("label_Layers")
        self.gridLayout_Mtl.addWidget(self.label_Layers, 1, 0, 1, 1)
        self.checkBox_TransparentBackground = QtWidgets.QCheckBox(parent=self.groupBox_Material)
        ...
        self.comboBox_TextureSize = QtWidgets.QComboBox(parent=self.groupBox_Material)
        ...
        self.label_Format = QtWidgets.QLabel(parent=self.groupBox_Material)
        self.label_Format.setObjectName("label_Format")
        self.gridLayout_Mtl.addWidget(self.label_Format, 3, 0, 1, 1)
        self.gridLayout_2 = QtWidgets.QGridLayout()
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.radioButton_PNG = QtWidgets.QRadioButton(parent=self.groupBox_Material)
        ...
        self.radioButton_JPEG = QtWidgets.QRadioButton(parent=self.groupBox_Material)
        ...
        self.groupBox_Tiles = QtWidgets.QGroupBox(parent=self.tab)
        ...
        self.checkBox_Tiles = QtWidgets.QCheckBox(parent=self.groupBox_Tiles)
        ...
        self.label_Roughness = QtWidgets.QLabel(parent=self.groupBox_Tiles)
        self.label_Roughness.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.label_Roughness.setObjectName("label_Roughness")
        self.gridLayout_Tiles.addWidget(self.label_Roughness, 0, 2, 1, 1)
        self.spinBox_Roughening = QtWidgets.QSpinBox(parent=self.groupBox_Tiles)
        ...
        self.spinBox_Size = QtWidgets.QSpinBox(parent=self.groupBox_Tiles)
        ...
        self.label_2 = QtWidgets.QLabel(parent=self.groupBox_Tiles)
        ...
        self.checkBox_Clip.toggled['bool'].connect(self.comboBox_ClipLayer.setVisible) # type: ignore
        self.checkBox_Clip.toggled['bool'].connect(self.checkBox_Frame.setDisabled) # type: ignore
        self.horizontalSlider_DEMSize.valueChanged['int'].connect(self.label_ResamplingLevel.setNum) # type: ignore
        ...
        self.checkBox_Clip.toggled['bool'].connect(self.checkBox_Wireframe.setDisabled) # type: ignore
        ...
        self.radioButton_PNG.toggled['bool'].connect(self.checkBox_TransparentBackground.setEnabled) # type: ignore
