...
class Ui_ScenePropertiesWidget(object):
    def setupUi(self, ScenePropertiesWidget):
        ...
        self.lineEdit_Rotation = QtWidgets.QLineEdit(parent=self.groupBox_4)
        self.lineEdit_Rotation.setInputMethodHints(QtCore.Qt.InputMethodHint.ImhFormattedNumbersOnly)
        ...
        ScenePropertiesWidget.setTabOrder(self.radioButton_PtLight, self.colorButton_Fog)
