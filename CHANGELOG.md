...
### Version 2.9
#### Qt6 / PyQt6 Support
- Added support for Qt6 and PyQt6 (supportsQt6=True)
- Import Qt classes from qgis.PyQt instead of PyQt5
- Use fully qualified Qt enumerated constant names
- Replace deprecated .exec_() with .exec()
- Added pyuic6.bat for UI file compilation
- Replace QtGui.QAction with QtWidgets.QAction

#### Project Structure Reorganization
- Restructured project directory by organizing source files into core, gui, lib, utils and web directories
- Split DEM builder.py into multiple files
- Split vector builder.py into multiple files
- Renamed multiple files to improve clarity (q3d*.py to *.py, q3dconst.py to const.py, etc.)
- Added LayerBuilderFactory for creating layer builder objects
- Moved classes and functions to more suitable modules

#### Logging and Debugging Improvements
- Replaced Logger class with standard Python logging module
- Added configureLoggers function and web_logger
- Log console messages with appropriate log level in Q3DWebEnginePage and Q3DWebKitPage
- Moved logging classes and functions to utils/logging.py
- Improved readability of non-gui test results
- Reduced use of DEBUG_MODE constant

#### Web View Enhancements
- Fixed issue where Q3DWindow.closeEvent was not fully executed when worker thread was not used
- Launch the exporter that displays messages in the view instead of showing a message box when WebEngine is unavailable
- Fixed saving current view as a PNG file
- Removed obsolete renderImage methods
- Use QWebEngineView/Page instead of QWebPage for testing exported page loading
- Fixed WebEngine/WebKit switching in export.py
- Moved WebEngine-specific function from Q3DWebPageCommon to Q3DWebEnginePage

#### Testing Improvements
- Added exported image size test
- Use assert methods of TestCase class
- Renamed tests/nongui directory to unit
- Updated test files to enable running specific tests from VS Code
- Separated export tests into web, image, and model categories
- Configure logger handlers based on test execution context
- Added ListHandler for testing
- Provide Python, QGIS and PyQt version info in test_basic.py

#### Code Refactoring and Cleanup
- Renamed Bridge class to WebBridge
- Renamed WebBridge methods from on* to emit*
- Renamed Script class to ScriptFile
- Renamed Q3DWebViewCommon.runScript method to logScriptExecution
- Renamed controller.buildingLayer to .processingLayer
- Disconnect signal-python_func connections
- Replace dummy* functions to noop
- Removed unused code related to page capturing
- Removed obsolete Q3DWindow.logToConsole method

#### Bug Fixes and Minor Improvements
- Fixed copyright year
- Ensure that rendering is done in ImageExporter.render()
- Revised message about 3D display limitation in web view
- Show a message stating that PyQt-WebEngine is not installed
- Updated Q3DDummyView
- Updated plugin icon
- Added batch files to launch Qt Designer without QGIS custom widgets

#### Documentation
- Added concurrency guide generated by AI
- Updated CONTRIBUTING.md
- Updated various code comments
