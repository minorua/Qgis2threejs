...
Mouse / Key               Control
=======================   ==============================================================
Left button + drag        Orbit (Rotates the camera around the focal point)
Scroll wheel              Zoom
Right button + drag       Pan (Moves the camera parallel to the screen)
Arrow keys                Move (Moves the camera on the horizontal plane)
...
Mouse / Key                Control
========================== ==========================================
Ctrl + Left button + drag  Look Around (Rotates the camera in place)
Ctrl + Arrow keys          Look Around
========================== ==========================================
