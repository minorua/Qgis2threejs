...
class Ui_Qgis2threejsDialog(object):
    def setupUi(self, Qgis2threejsDialog):
        ...
        self.formLayout.setWidget(1, QtGui.QFormLayout.FieldRole, self.comboBox_DEMLayer)
        ...
        self.formLayout.setWidget(0, QtGui.QFormLayout.SpanningRole, self.checkBox_useDEM)
