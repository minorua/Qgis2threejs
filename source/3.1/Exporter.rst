...
* Export button
   ...
   you can open the exported directory by clicking the hyperlink in the log. On Windows, a **[View page]** hyperlink is also
   displayed. Clicking this link starts a local web server and opens the exported web page in your default web browser.
