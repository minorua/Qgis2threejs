...
class Ui_WorldPropertiesWidget(object):
    def setupUi(self, WorldPropertiesWidget):
        ...
        self.formLayout = QtWidgets.QFormLayout(self.groupBox_1)
        ...
        self.lineEdit_MapCanvasExtent = QtWidgets.QLineEdit(self.groupBox_1)
        ...
        self.lineEdit_MapCanvasExtent.setObjectName("lineEdit_MapCanvasExtent")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.lineEdit_MapCanvasExtent)
        ...
        self.lineEdit_MapCanvasSize = QtWidgets.QLineEdit(self.groupBox_1)
        ...
        self.lineEdit_MapCanvasSize.setObjectName("lineEdit_MapCanvasSize")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.lineEdit_MapCanvasSize)
        ...
        self.lineEdit_BaseSize = QtWidgets.QLineEdit(self.groupBox_2)
        ...
        self.lineEdit_zFactor = QtWidgets.QLineEdit(self.groupBox_2)
        ...
        self.lineEdit_zShift = QtWidgets.QLineEdit(self.groupBox_2)
        ...
        self.radioButton_Sky = QtWidgets.QRadioButton(self.groupBox_3)
        ...
        self.radioButton_Color = QtWidgets.QRadioButton(self.groupBox_3)
        self.radioButton_Color.setObjectName("radioButton_Color")
        self.horizontalLayout_2.addWidget(self.radioButton_Color)
        self.lineEdit_Color = QtWidgets.QLineEdit(self.groupBox_3)
        ...
        self.toolButton_Color = QtWidgets.QToolButton(self.groupBox_3)
        ...
        self.groupBox_4 = QtWidgets.QGroupBox(WorldPropertiesWidget)
        self.groupBox_4.setObjectName("groupBox_4")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.groupBox_4)
        self.verticalLayout.setObjectName("verticalLayout")
        self.radioButton_ProjectCRS = QtWidgets.QRadioButton(self.groupBox_4)
        ...
        self.radioButton_WGS84 = QtWidgets.QRadioButton(self.groupBox_4)
    ...
    def retranslateUi(self, WorldPropertiesWidget):
        ...
        self.groupBox_1.setTitle(_translate("WorldPropertiesWidget", "Map canvas"))
        self.label_6.setText(_translate("WorldPropertiesWidget", "Extent"))
        self.label_7.setText(_translate("WorldPropertiesWidget", "Size"))
        self.groupBox_2.setTitle(_translate("WorldPropertiesWidget", "&Scale and shift"))
        ...
        self.groupBox_3.setTitle(_translate("WorldPropertiesWidget", "&Background"))
        ...
        self.groupBox_4.setTitle(_translate("WorldPropertiesWidget", "&Display of coordinates"))
