...
class Ui_ScenePropertiesWidget(object):
    def setupUi(self, ScenePropertiesWidget):
        ...
        ScenePropertiesWidget.resize(385, 585)
        ...
        self.checkBox_UseCanvasExtent = QtWidgets.QCheckBox(self.groupBox_4)
        self.checkBox_UseCanvasExtent.setObjectName("checkBox_UseCanvasExtent")
        self.gridLayout_3.addWidget(self.checkBox_UseCanvasExtent, 0, 0, 1, 2)
        ...
        self.gridLayout_3.addLayout(self.gridLayout_Extent, 6, 0, 1, 2)
        ...
        ScenePropertiesWidget.setTabOrder(self.checkBox_autoZShift, self.checkBox_UseCanvasExtent)
        ScenePropertiesWidget.setTabOrder(self.checkBox_UseCanvasExtent, self.lineEdit_CenterX)
        ...
        ScenePropertiesWidget.setTabOrder(self.pushButton_SelectExtent, self.comboBox_MaterialType)
    ...
    def retranslateUi(self, ScenePropertiesWidget):
        ...
        self.checkBox_UseCanvasExtent.setText(_translate("ScenePropertiesWidget", "Use map canvas extent"))
