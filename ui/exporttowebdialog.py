...
class Ui_ExportToWebDialog(object):
    def setupUi(self, ExportToWebDialog):
        ...
        ExportToWebDialog.resize(482, 208)
        ...
        self.label_GMA = QtWidgets.QLabel(self.groupBox)
        self.label_GMA.setObjectName("label_GMA")
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.label_GMA)
        self.lineEdit_GMA = QtWidgets.QLineEdit(self.groupBox)
        self.lineEdit_GMA.setMaximumSize(QtCore.QSize(100, 16777215))
        self.lineEdit_GMA.setInputMethodHints(QtCore.Qt.ImhPreferNumbers)
        self.lineEdit_GMA.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.lineEdit_GMA.setObjectName("lineEdit_GMA")
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.lineEdit_GMA)
    ...
    def retranslateUi(self, ExportToWebDialog):
        ...
        self.groupBox.setTitle(_translate("ExportToWebDialog", "Template Specific Settings"))
        self.label_GMA.setText(_translate("ExportToWebDialog", "Grid-Magnetic Angle (clockwise, in degrees)"))
        self.lineEdit_GMA.setText(_translate("ExportToWebDialog", "0"))
