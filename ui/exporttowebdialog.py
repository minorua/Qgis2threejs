...
class Ui_ExportToWebDialog(object):
    def setupUi(self, ExportToWebDialog):
        ...
        ExportToWebDialog.resize(593, 532)
        ...
        ExportToWebDialog.setTabOrder(self.lineEdit_MND, self.checkBox_Animation)
        ExportToWebDialog.setTabOrder(self.checkBox_Animation, self.comboBox_CameraMotion)
        ExportToWebDialog.setTabOrder(self.comboBox_CameraMotion, self.pushButton_Cancel)
        ...
        ExportToWebDialog.setTabOrder(self.pushButton_Close, self.textBrowser)
