...
class Ui_KeyframeDialog(object):
    def setupUi(self, KeyframeDialog):
        ...
        self.comboBoxEasing.setMinimumSize(QtCore.QSize(140, 0))
        self.comboBoxEasing.setObjectName("comboBoxEasing")
        self.gridLayoutLeft.addWidget(self.comboBoxEasing, 4, 1, 1, 1)
        ...
        self.gridLayoutLeft.addWidget(self.labelEasing, 4, 0, 1, 1)
        ...
        self.gridLayoutLeft.addItem(spacerItem, 5, 0, 1, 2)
        ...
        self.gridLayoutRight.addWidget(self.textEdit, 4, 0, 1, 2)
        self.labelNarration = QtWidgets.QLabel(KeyframeDialog)
        self.labelNarration.setObjectName("labelNarration")
        self.gridLayoutRight.addWidget(self.labelNarration, 3, 0, 1, 2)
