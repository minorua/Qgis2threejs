...
class Ui_Q3DWindow(object):
    def setupUi(self, Q3DWindow):
        ...
        self.menuNavigation = QtWidgets.QMenu(self.menuView)
        self.menuNavigation.setObjectName("menuNavigation")
        self.menuDecorations = QtWidgets.QMenu(self.menuView)
        ...
        self.menuNavigation.addAction(self.actionNavigationWidget)
        ...
        self.menuView.addAction(self.menuNavigation.menuAction())
        self.menuView.addAction(self.menuDecorations.menuAction())
    ...
    def retranslateUi(self, Q3DWindow):
        ...
        self.menuNavigation.setTitle(_translate("Q3DWindow", "Navigation"))
