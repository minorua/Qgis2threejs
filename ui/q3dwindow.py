...
class Ui_Q3DWindow(object):
    def setupUi(self, Q3DWindow):
        ...
        self.actionWorldSettings = QtWidgets.QAction(Q3DWindow)
        self.actionWorldSettings.setObjectName("actionWorldSettings")
        ...
        self.menuScene.addAction(self.actionWorldSettings)
    ...
    def retranslateUi(self, Q3DWindow):
        ...
        self.actionWorldSettings.setText(_translate("Q3DWindow", "World Settings..."))
