...
class Ui_DEMPropertiesWidget(object):
    def setupUi(self, DEMPropertiesWidget):
        ...
        DEMPropertiesWidget.resize(335, 598)
        ...
        self.gridLayout_2.addWidget(self.checkBox_Visible, 2, 0, 1, 1)
        ...
        self.toolButton_EdgeColor.setText("")
        ...
        DEMPropertiesWidget.setTabOrder(self.toolButton_EdgeColor, self.checkBox_Visible)
