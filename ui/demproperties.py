...
class Ui_DEMPropertiesWidget(object):
    def setupUi(self, DEMPropertiesWidget):
        ...
        DEMPropertiesWidget.resize(504, 766)
        ...
        self.gridLayout_Tiles.addWidget(self.label_3, 0, 2, 1, 1)
        ...
        DEMPropertiesWidget.setTabOrder(self.horizontalSlider_DEMSize, self.checkBox_Tiles)
