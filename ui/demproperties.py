...
class Ui_DEMPropertiesWidget(object):
    def setupUi(self, DEMPropertiesWidget):
        ...
        DEMPropertiesWidget.resize(435, 810)
        ...
        self.gridLayout_2.addWidget(self.checkBox_Frame, 2, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.checkBox_Visible, 4, 0, 1, 2)
        ...
        self.gridLayout_2.addWidget(self.toolButton_WireframeColor, 3, 1, 1, 1)
        self.checkBox_Wireframe = QtWidgets.QCheckBox(self.groupBox_Others)
        self.checkBox_Wireframe.setObjectName("checkBox_Wireframe")
        self.gridLayout_2.addWidget(self.checkBox_Wireframe, 3, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.toolButton_EdgeColor, 2, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.checkBox_Clickable, 5, 0, 1, 1)
        ...
        DEMPropertiesWidget.setTabOrder(self.lineEdit_Altitude, self.checkBox_Tiles)
        ...
        DEMPropertiesWidget.setTabOrder(self.comboBox_TextureSize, self.lineEdit_ImageFile)
