...
class Ui_DEMPropertiesWidget(object):
    def setupUi(self, DEMPropertiesWidget):
        ...
        self.label_GridSize = QtWidgets.QLabel(self.groupBox_Geometry)
        self.label_GridSize.setMinimumSize(QtCore.QSize(50, 0))
        self.label_GridSize.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_GridSize.setObjectName("label_GridSize")
        self.horizontalLayout.addWidget(self.label_GridSize)
    ...
    def retranslateUi(self, DEMPropertiesWidget):
        ...
        self.lineEdit_HRes.setToolTip(_translate("DEMPropertiesWidget", "This is for reference."))
        self.label_9.setText(_translate("DEMPropertiesWidget", "Y"))
        self.lineEdit_VRes.setToolTip(_translate("DEMPropertiesWidget", "This is for reference."))
