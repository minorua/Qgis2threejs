...
class Ui_VectorPropertiesWidget(object):
    def setupUi(self, VectorPropertiesWidget):
        ...
        self.gridLayout_9 = QtWidgets.QGridLayout(self.groupBox_zCoordinate)
        self.gridLayout_9.setContentsMargins(9, 3, 9, 3)
        self.gridLayout_9.setObjectName("gridLayout_9")
        self.verticalLayout_zCoordinate = QtWidgets.QVBoxLayout()
        self.verticalLayout_zCoordinate.setObjectName("verticalLayout_zCoordinate")
