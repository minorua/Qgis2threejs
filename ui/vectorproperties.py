...
class Ui_VectorPropertiesWidget(object):
    def setupUi(self, VectorPropertiesWidget):
        ...
        VectorPropertiesWidget.resize(451, 756)
        ...
        self.formLayout_4.setContentsMargins(14, -1, 14, -1)
        ...
        self.comboEdit_FilePath = StyleWidget(self.groupBox_FilePath)
        ...
        self.labelHeightWidget = StyleWidget(self.groupBox_Attrs)
        self.labelHeightWidget.setObjectName("labelHeightWidget")
        self.formLayout_Label.setWidget(1, QtWidgets.QFormLayout.SpanningRole, self.labelHeightWidget)
        ...
        VectorPropertiesWidget.setTabOrder(self.comboBox_ObjectType, self.radioButton_Expression)
