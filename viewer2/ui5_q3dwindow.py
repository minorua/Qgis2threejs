...
class Ui_Q3DWindow(object):
    def setupUi(self, Q3DWindow):
        ...
        self.listWidgetDebugView = QtWidgets.QListWidget(self.tab_2)
        self.listWidgetDebugView.setObjectName("listWidgetDebugView")
        self.verticalLayout_4.addWidget(self.listWidgetDebugView)
        self.lineEditInputBox = QtWidgets.QLineEdit(self.tab_2)
        self.lineEditInputBox.setObjectName("lineEditInputBox")
        self.verticalLayout_4.addWidget(self.lineEditInputBox)
    ...
    def retranslateUi(self, Q3DWindow):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("Q3DWindow", "Layer"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("Q3DWindow", "Dev"))
